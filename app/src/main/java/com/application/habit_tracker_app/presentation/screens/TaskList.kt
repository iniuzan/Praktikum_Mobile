...
import com.application.habit_tracker_app.presentation.components.TaskChip
...
import com.application.habit_tracker_app.presentation.viewmodels.TaskListViewModel
import com.application.habit_tracker_app.util.*
            ...
            Surface(modifier = Modifier
                ...
                Row(verticalAlignment = Alignment.CenterVertically, modifier = Modifier.background(MaterialTheme.colors.secondary.copy(0.25f))) {
                    ...
                    Column(
                        ...
                        Row(verticalAlignment = Alignment.CenterVertically, modifier = Modifier.padding(start = 8.dp)) {
                            Text(text = stringResource(R.string.sort_by), modifier = Modifier.padding(end = 8.dp))
                            TaskChip(
